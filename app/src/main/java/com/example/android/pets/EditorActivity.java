...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void insertPet(){
        ...
        String nameString = mBreedEditText.getText().toString().trim();
        values.put(COLUMN_PET_BREED,nameString);
        String breedString = mNameEditText.getText().toString().trim();
        values.put(COLUMN_PET_NAME,breedString);
    ...
    private void savePet(){
        ...
        values.put(COLUMN_PET_GENDER,mGender);
        int col = getContentResolver().update(Curruri,values,null,null);
